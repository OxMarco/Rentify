...
module.exports = {
  ...
  networks: {
    ...
    rinkeby: {
      url: "https://rinkeby.infura.io/v3/e56c2ce91d1434a8cfb71e6619829d1", //<---- YOUR INFURA ID! (or it won't work)
      accounts: {
        mnemonic: mnemonic(),
      },
    },
    kovan: {
      url: "https://kovan.infura.io/v3/e56c2ce91d1434a8cfb71e6619829d1", //<---- YOUR INFURA ID! (or it won't work)
      accounts: {
        mnemonic: mnemonic(),
      },
    },
    mainnet: {
      url: "https://mainnet.infura.io/v3/e56c2ce91d1434a8cfb71e6619829d1", //<---- YOUR INFURA ID! (or it won't work)
      accounts: {
        mnemonic: mnemonic(),
      },
    },
    ropsten: {
      url: "https://ropsten.infura.io/v3/e56c2ce91d1434a8cfb71e6619829d1", //<---- YOUR INFURA ID! (or it won't work)
      accounts: {
        mnemonic: mnemonic(),
      },
    },
    goerli: {
      url: "https://goerli.infura.io/v3/e56c2ce91d1434a8cfb71e6619829d1", //<---- YOUR INFURA ID! (or it won't work)
      accounts: {
        mnemonic: mnemonic(),
      },
    },
  ...
  etherscan: {
    ...
    apiKey: "EGJJIGDM4UK3W2ED9T3W5NDNS6HQUBHTPU"
  }
};
